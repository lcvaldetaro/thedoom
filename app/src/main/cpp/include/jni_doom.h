...
/**
 * doom.doom.jni.Natives.OnImageUpdate callback
 */
#define CB_CLASS_IU_CB  "OnImageUpdate"
#define CB_CLASS_IU_SIG  "([I)V"

/**
 * doom.doom.jni.Natives.OnInitGraphics(int, int) callback
 */
#define CB_CLASS_IG_CB  "OnInitGraphics"
#define CB_CLASS_IG_SIG  "(II)V"

/**
 * doom.doom.jni.Natives.OnStartSound callback
 */
